...
export function ExperimentRowActions({ experimentId, title }: { experimentId: string; title: string }) {
  ...
  return (
    <div className="flex items-center gap-1 justify-end">
      <Link href={`/admin/experiments/${experimentId}`} className="w-7 h-7 flex items-center justify-center text-a-ink-6 hover:text-a-ink-4 transition-colors duration-150">
